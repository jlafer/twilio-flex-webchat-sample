import { createStore, compose, applyMiddleware, combineReducers, Reducer, Store } from "redux";
...
export default function configureStore(reducers: ReducerDict) {
    const store: Store = createStore(createReducer(reducers, {}), compose(applyMiddleware(thunk)));
